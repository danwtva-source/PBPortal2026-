...
// --- Badge ---
export const Badge: React.FC<{ children: React.ReactNode; variant?: 'blue' | 'green' | 'purple' | 'red' | 'gray' }> = ({ children, variant = 'gray' }) => {
    const styles = {
    ...
    return <span className={`${styles[variant]} px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide`}>{children}</span>;
};